...
def verify_all_proofs(base_directory):
    ...
    required_questions = [
        ...
        4473, 4476,
        4483, 4489, 4523, 4796, 4797, 4892, 4898, 4910, 4923, 5080, 5116 , 5179, 5230, 5208, 5399, 5431, 5440, 5510, 5563,
        5645, 5708, 5779, 5805,
        5808, 6018, 6146, 6376, 6417, 6155, 6247, 6485, 6660, 6790, 6850, 6802, 6924
    ]
    results = []
