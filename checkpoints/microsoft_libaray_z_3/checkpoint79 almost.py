...
class GeometricTheorem:
    ...
    def generate_detailed_feedback_for_variable(self, variable_name, model_answer, computed_value=None,
        ...
        # Get all constraints using our constraint finder
        try:
            result = self.find_relevant_constraints(variable_name)

            # Add all direct constraints first
            for constraint in result["direct_constraints"]:
                unique_constraints.add(constraint)

            # Then add related constraints if they're not duplicates
            ...
            # Custom sort: Put constraints containing the variable name first
            def constraint_sort_key(constraint):
                # If constraint contains the variable, give it priority 0, otherwise priority 1
