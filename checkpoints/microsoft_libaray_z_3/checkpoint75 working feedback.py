...
class GeometricTheorem:
    ...
    def generate_detailed_feedback(self, goal_type, goal_token, model_answer, computed_value=None,
        ...
        if status == "unsatisfiable":
            ...
            report += f"Your proof determines the {goal_type} of {goal_token} to be {computed_value}, not {model_answer}. Check your calculations and theorem applications.\n"
    ...
    def generate_detailed_feedback_for_variable(self, variable_name, model_answer, computed_value=None,
        ...
        if status == "unsatisfiable":
            ...
            report += f"Your proof determines the value of {variable_name} to be {computed_value}, not {model_answer}. Check your calculations and theorem applications.\n"
