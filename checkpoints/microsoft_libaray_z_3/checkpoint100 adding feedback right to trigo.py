...
class GeometricTheorem:
    ...
    def evaluate_trig_function(self, func_name, angle_token, model_answer):
        ...
        if check_result == unsat:
            ...
            print(f"Contradiction detected in evaluate_trig_function: {details}")
            ...
            try:
                ...
                if temp_solver.check() == unsat:
                    ...
                    print(f"Angle {angle_token} is not uniquely determined")
            except Exception as e:
                print(f"Error evaluating angle {angle_token}: {e}")
            ...
            if related_constraints:
                print(f"Related constraints for {func_name}({angle_token}):")
                for constraint in related_constraints:
                    print(f"  {constraint}")
            else:
                print(f"No specific constraints found for {func_name}({angle_token})")
            ...
            if not angle_constraints:
                print(f"No constraints found for angle {angle_token} - insufficient information")
