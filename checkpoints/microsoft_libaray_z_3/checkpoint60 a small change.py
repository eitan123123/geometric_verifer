...
def verify_all_proofs(base_directory):
    ...
    required_questions = [
        ...
        2624, 2669, 2761, 2851, 2916, 2999, 3027, 3272, 3983, 4254, 4473, 4476,
        4483, 4523, 4796, 4797, 4892, 4898, 4910, 4923, 5208, 5399, 5645, 5708,
        5808, 6018, 6155, 6247, 6790, 6802, 6924
    ]
    results = []
